   ...
   <div class="col-lg-12">
      <div class="iq-card">
         ...
         <div class="iq-card-body">
            ...
            <form action="{{ route('post.store',$course->id) }}" method="post" >
             @csrf
             
             <div class="form-group">
              <label for="title">Title</label>
              <input type="text" class="form-control mb-0 @error('title') is-invalid @enderror" id="title" name="title" placeholder="Type post title"value="{{ old('title') }}">
              @error('title')
             ...
             <div class="row mb-3">
               ...
               <a href="{{ route('course.show',$course->id) }}"class="btn iq-bg-danger">Cancel</a>
